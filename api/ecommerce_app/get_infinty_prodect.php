...
,(SELECT COUNT(offer_product.id) FROM offer_product WHERE offer_product.product_id=product.id AND offer_product.active=1 AND state = 1) AS if_offer_product

,(SELECT COUNT(offer_product.id) FROM offer_product WHERE offer_product.product_id=product.id AND offer_product.active=1 AND state = 2) AS if_Delivery_product
...
FROM `product` WHERE product.is_active=1
